...
var request = /*#__PURE__*/Object.freeze({
    ...
    sendRequestFormData: sendRequestFormData
});
...
var auth$1 = /*#__PURE__*/Object.freeze({
    __proto__: null,
    getAccessTokenFromEnv: getAccessTokenFromEnv,
    getProfile: getProfile,
    isLogged: isLogged,
    loginByExchangingToken: loginByExchangingToken,
    logout: logout,
    updateEnvToken: updateEnvToken,
    verify: verify
});
...
var Client = /** @class */ (function () {
    ...
    Client.prototype.getAuthCode = function (email, ctoken, scene) {
    ...
    Client.prototype.updateMeEmail = function (email, code) {
        return this.request("/users/me/email", 'PUT', {
            email: email,
            code: code
        });
    };
    Client.prototype.updateMeOptions = function (options) {
    ...
    Client.prototype.getListDeliveryTasks = function (list_id, offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 10; }
        return this.request("/lists/".concat(list_id, "/delivery?offset=").concat(offset, "&limit=").concat(limit), 'GET', null);
    };
    Client.prototype.getListDeliveryTask = function (list_id, task_id) {
        return this.request("/lists/".concat(list_id, "/delivery/").concat(task_id), 'GET', null);
    };
    Client.prototype.cancelScheduledDeliveryTask = function (list_id, task_id) {
    ...
    Client.prototype.searchPosts = function (q, list, offset) {
    ...
    Client.prototype.getTwitterAuthUrl = function (list_id) {
    ...
    Client.prototype.updateListOptions = function (list_id, options) {
        return this.request("/lists/".concat(list_id, "/options"), 'PUT', {
            options: options,
        });
    };
    Client.prototype.createListExport = function (list_id) {
    ...
    Client.prototype.updatePostOptions = function (listID, postID, options) {
    ...
    Client.prototype.deliverPost = function (listID, slug, scheduledAt, channels) {
    ...
    Client.prototype.uploadAttachment = function (formData, encrypted) {
        var appended = '';
        if (encrypted) {
    ...
    // pack
    Client.prototype.getListPacks = function (list_id) {
        return this.request("/lists/".concat(list_id, "/packs"), 'GET', null);
    };
    Client.prototype.getListPack = function (list_id, pack_id) {
        return this.request("/lists/".concat(list_id, "/packs/").concat(pack_id), 'GET', null);
    };
    Client.prototype.createListPack = function (list_id, payload) {
        return this.request("/lists/".concat(list_id, "/packs"), 'POST', payload);
    };
    Client.prototype.updateListPack = function (list_id, pack_id, payload) {
        return this.request("/lists/".concat(list_id, "/packs/").concat(pack_id), 'PUT', payload);
    };
    Client.prototype.deleteListPack = function (list_id, pack_id) {
...
export { AuxiliaClient, Client, auth$1 as auth, error, i18n, request, util };
