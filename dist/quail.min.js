...
var Client = /** @class */ (function () {
    ...
    Client.prototype.getPostPreviewUrl = function (listID, slug) {
        return "".concat(this.apibase, "/lists/").concat(listID, "/posts/").concat(slug, "/preview?access_token=").concat(this.getAccessToken());
    };
