...
var Client = /** @class */ (function () {
    ...
    Client.prototype.searchPhotos = function (query, page, perPage) {
        if (page === void 0) { page = 1; }
        if (perPage === void 0) { perPage = 10; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/composer/photos/search?query=".concat(encodeURIComponent(query), "&page=").concat(page, "&perPage=").concat(perPage), 'GET', null)];
            });
        });
    };
