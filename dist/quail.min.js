...
var Client = /** @class */ (function () {
    ...
    Client.prototype.incCount = function (post_id, field) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/posts/".concat(field, "?id=").concat(post_id), 'POST', null)];
            });
        });
    };
    Client.prototype.getExploreTrendingPosts = function (offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 10; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/explore/trending/posts?offset=".concat(offset, "&limit=").concat(limit), 'GET', null)];
            });
        });
    };
    Client.prototype.getExploreTrendingLists = function (offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 10; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/explore/trending/lists?offset=".concat(offset, "&limit=").concat(limit), 'GET', null)];
            });
        });
    };
    return Client;
