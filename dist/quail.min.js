...
var Client = /** @class */ (function () {
    ...
    // tweets
    Client.prototype.getTweets = function (list_id, offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 16; }
        return this.request("/tweets?list=".concat(list_id, "&offset=").concat(offset, "&limit=").concat(limit), 'GET', null);
    };
    Client.prototype.getPinnedTweets = function (list_id) {
        return this.request("/tweets/pinned?list=".concat(list_id), 'GET', null);
    };
    Client.prototype.createTweet = function (payload) {
        return this.request("/tweets?list=".concat(payload.list_id), 'POST', payload);
    };
    ...
    Client.prototype.getTweetReplies = function (tweet_id, list_id, offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 16; }
        return this.request("/tweets/".concat(tweet_id, "?list=").concat(list_id, "&offset=").concat(offset, "&limit=").concat(limit), 'GET', null);
    };
    ...
    Client.prototype.deleteTweetReply = function (reply_id) {
        return this.request("/tweets/0/replies/".concat(reply_id), 'DELETE', null);
    };
    return Client;
}());
