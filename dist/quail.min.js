...
var Client = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (json.code) {
                            ...
                            throw new Error("".concat(json.code, ": ").concat(json.message || json.msg));
                        }
    ...
    Client.prototype.upgradeSubscription = function (list_id, redirect_url, plan) {
        if (redirect_url === void 0) { redirect_url = ""; }
        if (plan === void 0) { plan = "paid-yearly"; }
        return this.request("/subscriptions/".concat(list_id, "/upgrade?redirect_url=").concat(redirect_url, "&plan=").concat(plan), 'POST', null);
    };
    Client.prototype.getListPosts = function (list_id, offset, limit) {
        if (offset === void 0) { offset = 0; }
        if (limit === void 0) { limit = 10; }
        return this.request("/lists/".concat(list_id, "/posts?offset=").concat(offset, "&limit=").concat(limit), 'GET', null);
    };
    ...
    Client.prototype.updateListSlug = function (list_id, slug) {
        return this.request("/lists/".concat(list_id, "?slug=").concat(slug), 'PUT', null);
    };
    Client.prototype.getListSubscriptions = function (list_id, offset, limit) {
        return this.request("/lists/".concat(list_id, "/subscriptions?offset=").concat(offset, "&limit=").concat(limit), 'GET', null);
    };
    ...
    Client.prototype.generateFrontmatter = function (title, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/composer/frontmatter", 'POST', {
                        title: title,
                        content: content
                    })];
            });
    ...
    Client.prototype.generateMetadata = function (title, content) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/composer/metadata", 'POST', {
                        title: title,
                        content: content
                    })];
            });
    ...
    Client.prototype.searchPhotos = function (query, page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.request("/composer/unsplash/photos/search?query=".concat(query, "&page=").concat(page, "&limit=").concat(limit), 'GET', null)];
            });
        });
    };
    Client.prototype.getPhotoDownloadUrl = function (endpoint) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.request("/composer/unsplash/photos/download_url?endpoint=".concat(endpoint), 'GET', null)];
            });
        });
    };
    Client.prototype.createPost = function (listID, payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/lists/".concat(listID, "/posts"), 'POST', payload)];
            });
        });
    };
    Client.prototype.updatePost = function (listID, postID, payload) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/lists/".concat(listID, "/posts/").concat(postID, "/update"), 'PUT', payload)];
            });
        });
    };
    Client.prototype.publishPost = function (listID, slug) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/lists/".concat(listID, "/posts/").concat(slug, "/publish"), 'PUT', null)];
            });
        });
    };
    Client.prototype.unpublishPost = function (listID, slug) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/lists/".concat(listID, "/posts/").concat(slug, "/unpublish"), 'PUT', null)];
            });
        });
    };
    Client.prototype.deliverPost = function (listID, slug) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/lists/".concat(listID, "/posts/").concat(slug, "/deliver"), 'PUT', null)];
            });
        });
    };
    Client.prototype.uploadAttachment = function (formData) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.requestFormData("/attachments", formData)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    Client.prototype.view = function (post_id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.request("/posts/view?id=".concat(post_id), 'POST', null)];
            });
        });
    };
    return Client;
